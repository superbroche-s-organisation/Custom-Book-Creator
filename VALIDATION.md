...
- `plugin.json` reports version `1.0.1`;
...
The binary contract test is available in `tests/BinaryContractTest.java`. Template regressions are covered by `tests/StartingBookTemplateTest.java` and `tests/UrlOpeningTemplateTest.java`.
